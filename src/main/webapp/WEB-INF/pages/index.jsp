...
<body id="page-top">
	...
	<div id="wrapper">
		...
		<ul class="sidebar navbar-nav" id="left_menu">
			<li class="nav-item active"><a class="nav-link" href="admin"> <i class="fas fa-fw fa-tachometer-alt"></i> <span>后台首页</span>
			</a></li>
			...
			<li class="nav-item"><a class="nav-link" href="user/index"> <i class="fas fa-fw fa-chart-area"></i> <span>用户管理</span></a></li>
	...
	<script type="text/javascript">
		$(document).ready(function(){
			$('#left_menu').off('click','a').on('click','a',function(){
				//将当前的超连接的href的属性的值取出
				var href = $(this).attr("href");
				//console.log(href);
				$.ajax({
					url:href,
					// dataType 如果不写，ajax会自动的匹配 后台响应的数据格式。
					///dataType:'html',//期望后台能响应的数据格式
					success:function(htmlData){
						$('#content-wrapper').html(htmlData);
					}
				});
